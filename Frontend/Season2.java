...
public class Season2 extends javax.swing.JFrame {
Connection Con=null;
PreparedStatement pst=null;

ResultSet rs=null;
    /**
     * Creates new form Season2
     */
    public Season2() {
        initComponents();
        setTitle("signin");
...
new f6().setVisible(true);        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Season2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
